    ...
    <div class="homepage-container">
        <div class="homepage-cover" :style="{'background-image': 'url('+mainBgUrl+')'}">
            <div class="homepage-intro">
                ...
                <button class='model-btn basic-btn' @click="routeToTryModel">Try it now!</button>
                <button class='model-btn basic-btn' @click="routeToUsermanual">User Manual</button>
            </div>
        </div>
...
const routeToTryModel = () => {
    console.log('turn to model page');
    push('/model');
};
const routeToUsermanual = () => {
    console.log('turn to user manual page');
    push('/usermanual');
};
